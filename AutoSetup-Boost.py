...
su -c "settings put global development_settings_enabled 1" && su -c "am kill-all" && su -c "cd /sdcard/Download && export PATH=\$PATH:/data/data/com.termux/files/usr/bin && export TERM=xterm-256color && python ./AutoSetup-Boost.py"
